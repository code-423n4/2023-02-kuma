...
- Total Prize Pool: Sum of below awards
  ...
  - (this line can be removed if there is no mitigation) Mitigation review contest: XXX XXX (_Opportunity goes to top X certified wardens based on placement in this contest._)
